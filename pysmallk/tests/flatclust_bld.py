...
from pysmallk import flatclust as fc
...
fc.load_matrix(filepath=args.matrixfile)
fc.load_dictionary(args.dictfile)

# use the user-provided inputs to run flat clustering
# all keyword arguments are optional 
fc.cluster(args.clusters, infile_W=args.infile_W, infile_H=args.infile_H,
...
fc.write_output(args.assignfile, args.treefile, outdir=args.outdir, format=args.format)
