...
from pysmallk import hierclust as hc
...
hc.load_matrix(filepath=args.matrixfile)
hc.load_dictionary(args.dictfile)

# use the user-provided inputs to run hierarchical clustering
# all keyword arguments are optional 
hc.cluster(args.clusters, infile_W=args.infile_W, infile_H=args.infile_H,
...
hc.write_output(args.assignfile, args.treefile, outdir=args.outdir, format=args.format)
