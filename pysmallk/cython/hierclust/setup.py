...
more_sources = [smallk_path + "hierclust/src/command_line.cpp",
                smallk_path + "hierclust/src/clust.cpp",
...
more_sources += [smallk_path + "common/src/matrix_market_file.cpp",
                 ...
                 smallk_path + "common/src/system_posix.cpp",
...
ext_modules = [
    Extension(
        name = "libhierclust",
        sources = ["interface/hierclust_lib.pyx"]+more_sources,
        include_dirs = ["/usr/local/include", "/usr/include", smallk_path + "common/include", smallk_path + "hierclust/include", elem_include, numpy.get_include()],
