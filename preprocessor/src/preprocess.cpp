...
// //-----------------------------------------------------------------------------
// void HashColsXXH32(const unsigned int width,
//                    const unsigned int* cols,
//                    const TFData* tf_data,
//                    std::vector<IndexedData>& hash)
// {
//     const uint64_t XXH_HASH_SEED = 42u;
...
//         uint64_t hashval = XXH32(&tf_data[start], 
//                                  (end-start)*sizeof(TFData),
//                                  XXH_HASH_SEED);
                ...
                unsigned int& new_nz)
{
    ...
    //HashColsJenkins32(width, cols, rows, hash);
    //HashColsXXH32(width, cols, rows, hash);
